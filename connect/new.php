            ...
            <div style="width:100%;min-width:300px">
                ...
                <div id="list" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="hvr-grow" id="abbtn" ><a href="#about"><i class="fa fa-info-circle"></i>About</a></li>
                        <li class="hvr-grow" id="edbtn" ><a href="#education"><span class="glyphicon glyphicon-education"></span>Education</a></li>
                        <li class="hvr-grow" id="cebtn" ><a href="#certifications"><span class="glyphicon glyphicon-certificate"></span>Certifications</a></li>
                        <li class="hvr-grow" id="prbtn" ><a href="#projects"><span class="glyphicon glyphicon-wrench"></span>Projects</a></li>
                        <li class="hvr-grow" id="intbtn" ><a href="#internship"><span class="glyphicon glyphicon-book"></span>Internship</a></li>
                        <li class="hvr-grow" id="cobtn" ><a href="#contact"><i class="fa fa-phone"></i>Contact</a></li>
                    </ul>
                </div>
